...
func TestUnifiRetriever_GetIPAddress(t *testing.T) {
	...
	ret := UnifiRetriever{baseURL: server.URL, apiKey: testAPIKey, siteID: "default", client: server.Client()}
...
func TestUnifiRetriever_GetIPAddress_Unauthorized(t *testing.T) {
	...
	ret := UnifiRetriever{baseURL: server.URL, apiKey: "wrong-key", siteID: "default", client: server.Client()}
...
func TestUnifiRetriever_GetIPAddress_MissingWanIP(t *testing.T) {
	...
	ret := UnifiRetriever{baseURL: server.URL, apiKey: "key", siteID: "default", client: server.Client()}
...
func TestUnifiRetriever_GetIPAddress_CustomSiteID(t *testing.T) {
	...
	ret := UnifiRetriever{baseURL: server.URL, apiKey: "key", siteID: customSite, client: server.Client()}
